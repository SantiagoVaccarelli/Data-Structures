...
static void borrar_2_hijos()
{
    ...
    char *clave4 = "gaviota", *valor4 = "grito";

    print_test("Insertamos la clave1 con el valor1", abb_guardar(abb, clave1, valor1));
    print_test("Insertamos la clave2 con el valor2", abb_guardar(abb, clave2, valor2));
    print_test("Insertamos la clave3 con el valor3", abb_guardar(abb, clave3, valor3));
    print_test("Insertamos la clave4 con el valor4", abb_guardar(abb, clave4, valor4));

    print_test("Pruebo borrar la raiz que tiene dos hijos", abb_borrar(abb, clave1) == valor1);
    print_test("Prueba abb la cantidad de elementos es 3", abb_cantidad(abb) == 3);
    printf("%li", abb->cantidad);
    abb_destruir(abb);
}
...
static void prueba_iterar_abb_vacio()
{
    ...
    print_test("Prueba abb iter crear iterador hash vacio", iter != NULL);
...
static void prueba_abb_iterar()
{
    ...
    print_test("Prueba ver actual es la clave0", strcmp(abb_iter_in_ver_actual(iter), claves[0]) == 0);
    abb_iter_in_avanzar(iter);
    print_test("Prueba ver actual es la clave1", strcmp(abb_iter_in_ver_actual(iter), claves[1]) == 0);
